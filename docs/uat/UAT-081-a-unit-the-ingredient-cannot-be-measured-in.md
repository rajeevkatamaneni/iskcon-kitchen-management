...
- The refusal is **`KMS-400013`** — *That quantity is in a unit this ingredient can't be measured in.*
...
| 3 | Set Change to `-2`, Reason **Spoilage**, Unit **L**, and press **Record adjustment** | **Refused.** *That quantity is in a unit this ingredient can't be measured in.* — and under it *Weight, volume and pieces don't convert into one another. Use the unit the ingredient is held in.*, quoting **`KMS-400013`** |
...
| 9 | Open **/inventory** → **Ghee** and try Change `-1`, Unit **Kg** | **Refused**, `KMS-400013`. Ghee is poured, not weighed |
| 10 | Try Ghee with Unit **ml** | **Accepted** — same family |
| 11 | Open **/inventory** → **Coconut** and try Change `-1`, Unit **Kg**, then **L** | **Refused both times**, `KMS-400013`. A count converts to nothing |
...
| # | Do this | You should see |
|---|---|---|
| 13 | Go to **/donations/new** and record a gift of goods (UAT-028) with **one** line: **Rice**, quantity `5`, unit **L** | **Refused**, `KMS-400013`. The gift is **not** recorded |
...
| 16 | Record a two-line gift: **Rice** `5` **Kg** (fine) and **Ghee** `2` **Kg** (nonsense) | **Refused**, `KMS-400013` — and **neither** line is written. An order or a gift is decided as a whole, never half-written |
...
| # | Do this | You should see |
|---|---|---|
| 18 | **Ask the person who set up the environment** to do this one, because no screen in the application lets you choose a unit on a purchase-order line — it always uses the ingredient's own. Ask them to send an update to a **draft** purchase order (UAT-039) with one line changed to a unit from another family — Rice in `L` — straight to the system behind the site | **Refused** with **`KMS-400013`**, and the refusal carries a line naming the ingredient: *Rice is measured in Kg, and there is no way to turn L into Kg.* The draft is **unchanged** — no line is written |
...
- [ ] A quantity in a unit from another family is refused with **`KMS-400013`** wherever it is entered.
