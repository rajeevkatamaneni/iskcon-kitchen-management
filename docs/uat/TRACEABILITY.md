...
| E1-S16 | Signing out, and idle sign-out | **UAT-063** — to be written with the story |
...
| INT-3 | All screens | Minor | E1-S6 | R3 (developer oversight) | OPEN | The sidebar reads "Your temple" — a placeholder — so the app never says which temple you are working in. With more than one temple that is a real hazard. |
