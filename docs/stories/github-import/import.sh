...
echo "  E7-S1"; gh issue create --repo "$REPO" --title "E7-S1: Public temple donation page" --body-file "bodies/e7-s1.md" --label "story,epic:payments" --milestone "Epic 7: Payments & Donations" >/dev/null
...
echo "  E7-S4"; gh issue create --repo "$REPO" --title "E7-S4: 80G donor data capture and anonymity choice" --body-file "bodies/e7-s4.md" --label "story,epic:payments" --milestone "Epic 7: Payments & Donations" >/dev/null
...
echo "  E7-S6"; gh issue create --repo "$REPO" --title "E7-S6: Public wish list and sponsorship checkout" --body-file "bodies/e7-s6.md" --label "story,epic:payments" --milestone "Epic 7: Payments & Donations" >/dev/null
