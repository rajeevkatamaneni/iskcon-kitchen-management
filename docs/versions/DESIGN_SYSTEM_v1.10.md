...
**Where it stops: five.** A form of four fields or fewer is edited inline, where the thing is shown —
no separate screen and no edit-and-save round trip. Five or more becomes a screen. Sending somebody
to another screen to type one word is friction, not focus. The number matters more than the
judgement: a form that grows a fifth field converts on its own rather than by anybody's opinion.
...
*Note: this rule was changed on 2026-09-12 (v1.8), from "four fields or more becomes a screen" and
"anywhere a button used to open a form on top of a list, the form is its own screen". Rajeev asked
that it not be applied retroactively — "Just update the rule for the future. DOESNOT have to be
applied retroactivly." Screens built before that date stay as they are.*
