...
**Status:** LOCKED — v1.0, approved 2026-08-03. Stage 2 complete.
**Version:** 1.0
...
- **Business observability:** a lightweight admin ops page — last successful calendar precompute, reminder jobs sent/failed today, webhook failures — because at pilot scale *silent* job failure is the likeliest incident.
