...
public record MasterRecipeView(
	 ...
	 *                 the book wrote it, or null where it says nothing. The books vendored until
	 *                 2026-09-19 kept it inside the name after a comma ("Green chilli, slit") and
	 *                 this was null for every one of their lines; the curated catalogue that replaced
	 *                 them names the ingredient plainly and fills this instead, which is the only
	 *                 record of its 83 notes. The import prefers it over splitting the name — see
	 ...
	 *                 buys this", which is the answer for 439 of the catalogue's 454 lines and was for
	 *                 every one of the 46,337 vendored ones.
	 * @param scaled   the book's own arithmetic at 50, 100, 250 and 500 devotees, where it did any.
	 *                 Null on every line of the curated catalogue, which precomputes none; present on
	 *                 19,356 of the vendored library's 46,337 lines.
	 */
