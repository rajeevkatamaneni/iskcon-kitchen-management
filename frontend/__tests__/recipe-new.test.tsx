...
describe("new recipe", () => {
  beforeEach(() => {
    ...
    ingRef.current = {
      data: [
        { id: "i1", name: "Rice", category: "Grains", unit: "KG", packSizes: [], marketRate: null, marketRateOn: null, marketRateSource: null, ekadashiProhibited: false, supply: false, libraryDerived: false, aliases: [], createdAt: "" },
      ],
      error: null,
      loading: false,
    };
