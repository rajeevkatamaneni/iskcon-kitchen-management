...
export const THEME_PACKS: ThemePack[] = [
  {
    ...
    palette: {
      ...
      "sunken": "#ECECF3",
      "hairline": "#DBDBE6",
      "hairline-strong": "#C9C9DA",
      "ink": "#1B1C33",
      "ink-secondary": "#545675",
      "ink-muted": "#686A80",
      "ink-inverse": "#F8F8FC",
      "accent-bg": "#E8E7F4",
      "accent-border": "#D2D1EA",
      "accent": "#3B3A8F",
      "accent-hover": "#2C2B72",
      "accent-text": "#2C2B72",
      "focus-ring": "#7B82D0",
      ...
      "meter-mid": "#B37E1D",
      "meter-high": "#2F6B54",
      "meter-pledged": "#A88239",
      "meter-neutral": "#858699",
    },
  },
  {
    id: "ocellus-green-barbule",
    name: "Ocellus / green barbule",
    family: "BALANCED",
    description:
  ...
  },
  {
    ...
    palette: {
      ...
      "meter-mid": "#B27C1B",
      "meter-high": "#2F6B54",
      "meter-pledged": "#A78138",
      "meter-neutral": "#7E858F",
    },
  },
  {
    id: "ocellus-full-plume",
    name: "Ocellus / full plume",
    family: "BALANCED",
    description:
  ...
  },
  {
    ...
    palette: {
      ...
      "success-bg": "#E7EFE8",
      success: "#3E6B48",
      // Meters, added 2026-08-30 with the Ocellus packs. Hues matched to this pack's own status
      // colours so a bar reads as part of the same family, then each solved to 3:1 against
      // `sunken` — the track it sits in, and the only thing it has to be distinguishable from.
      "meter-low": "#D06A61",
      "meter-mid": "#AA821E",
      "meter-high": "#409A59",
      "meter-pledged": "#B17F41",
      "meter-neutral": "#8F8882",
    },
  },
];
